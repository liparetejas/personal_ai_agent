...
async def process_user_request(
    ...
    """
    Process user request using Gemini with all available MCP tools.
    ...
    # Prepare tools list from all sessions
    all_tools = []
    for session_name, session in sessions.items():
        if session:
            all_tools.append(session)
...
async def main():
    ...
    print("\n🚀 Starting Unified Batak Assistant...\n")
                            ...
                            async with ClientSession(calendar_read, calendar_write) as calendar_session:
                                ...
                                async with stdio_client(websearch_params) as websearch_transport:
                                    ...
                                    async with ClientSession(websearch_read, websearch_write) as websearch_session:
                                        ...
                                        # ========== Interactive Loop ==========
                                        print("\n" + "=" * 70)
                                        print("🦆 Batak - Your Unified Personal Assistant")
                                        print("=" * 70)
